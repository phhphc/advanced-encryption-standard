...
def CBCmode(k, m , IV = [0xf7 ,0x72 ,0xb7 ,0x54 ,0xf1 ,0x4f ,0xb0 ,0x2a ,0x8b ,0x5e ,0xe1 ,0xf1 ,0x8c ,0xd9 ,0xac ,0xd5]):
...
print(CBCmode('54 68 61 74 73 20 6D 75 54 68 61 74 73 20 6D 79 54 68 61 74 73 20 6D 75 54 68 61 74 73 20 6D 79'.replace(' ', ''), 'Two One Nine Two'))
